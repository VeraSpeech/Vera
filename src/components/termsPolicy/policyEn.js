  ...
  return (
    <div className="bgwhite">
      <div id="paddingTerm">
        ...
        Vera Technology Company Limited built the Vera Speech App app as a Free
        app. This SERVICE is provided by Vera Technology Company Limited at no
        cost and is intended for use as is. This page is used to inform visitors
        ...
        meanings as in our Terms and Conditions, which are accessible at Vera
        Speech App unless otherwise defined in this Privacy Policy. Information
        Collection and Use For a better experience, while using our Service, we
        may require you to provide us with certain personally identifiable
        information, including but not limited to voice samples. The information
        ...
        third-party service providers used by the app Google Play Services Log
        Data We want to inform you that whenever you use our Service, in a case
        ...
        Service, and other statistics. Cookies Cookies are files with a small
        amount of data that are commonly used as anonymous unique identifiers.
        These are sent to your browser from the websites that you visit and are
        stored on your device's internal memory. This Service does not use these
        ...
        Service. Service Providers We may employ third-party companies and
        individuals due to the following reasons: To facilitate our Service; To
        provide the Service on our behalf; To perform Service-related services;
        or To assist us in analyzing how our Service is used. We want to inform
        ...
        the information for any other purpose. Security We implement reasonable
        security measures to protect Personal Information and voice samples
        collected through the App. However, no data transmission or storage
        system can be guaranteed to be 100% secure. We cannot guarantee the
        security of information transmitted through the App. Links to Other
        Sites This Service may contain links to other sites. If you click on a
        third-party link, you will be directed to that site. Note that these
        external sites are not operated by us. Therefore, we strongly advise you
        to review the Privacy Policy of these websites. We have no control over
        and assume no responsibility for the content, privacy policies, or
        practices of any third-party sites or services. Changes to This Privacy
        Policy We may update our Privacy Policy from time to time. Thus, you are
        advised to review this page periodically for any changes. We will notify
        you of any changes by posting the new Privacy Policy on this page. This
        policy is effective as of 2023-09-22 Contact Us If you have any
        questions or suggestions about our Privacy Policy, do not hesitate to
        contact us at veraspeechapp@gmail.com. 11. **Terms of service:** Terms
        of service that govern the use of your app. –draft– Terms & Conditions
        Consent and Parental Responsibility By downloading or using the App, you
        represent that you have read, understood, and agreed to be bound by
        these Terms & Conditions. If you are using the App on behalf of a minor,
        you confirm that you are the parent or legal guardian of the minor and
        have the authority to enter into this Agreement on their behalf. 2.
        Intellectual Property You’re not allowed to copy or modify the app, any
        part of the App, or our trademarks in any way. You’re not allowed to
        ...
        belong to Vera Technology Company Limited. 3. Security The App stores
        and processes personal data that you have provided to us, to provide our
        ...
        Vera Speech App app won’t work properly or at all. 4. Third-Party Links
        and Services The app does use third-party services that declare their
        Terms and Conditions. Link to Terms and Conditions of third-party
        service providers used by the app Google Play Services 5. Network
        Connection You should be aware that there are certain things that Vera
        Technology Company Limited will not take responsibility for. Certain
        ...
        network provider, but Vera Technology Company Limited cannot take
        ...
        the bill payer for using the app. 6. Limitation of Liability Along the
        same lines, Vera Technology Company Limited cannot always take
        ...
        turn it on to avail the Service, Vera Technology Company Limited cannot
        accept responsibility. With respect to Vera Technology Company Limited’s
        responsibility for your use of the app, when you’re using the app, it’s
        important to bear in mind that although we endeavor to ensure that it is
        updated and correct at all times, we do rely on third parties to provide
        information to us so that we can make it available to you. Vera
        Technology Company Limited accepts no liability for any loss, direct or
        indirect, you experience as a result of relying wholly on this
        functionality of the app. 6. Modifications and Updates Vera Technology
        Company Limited is committed to ensuring that the app is as useful and
        ...
        making it very clear to you exactly what you’re paying for. At some
        point, we may wish to update the app. The app is currently available on
        Android and iOS – the requirements for the systems (and for any
        ...
        using the app. Vera Technology Company Limited does not promise that it
        ...
        using the app, and (if needed) delete it from your device. 7. Changes to
        This Terms and Conditions We may update our Terms and Conditions from
        time to time. Thus, you are advised to review this page periodically for
        any changes. We will notify you of any changes by posting the new Terms
        and Conditions on this page. These Terms and Conditions are effective as
        of 2023-09-22 8. Contact Us If you have any questions or suggestions
        about our Terms and Conditions, do not hesitate to contact us at
        veraspeechapp@gmail.com.
      </div>
    </div>
  );
}
